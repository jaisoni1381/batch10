try{
    node{
        ...
        stage('publish report'){
            ...
            publishHTML(target: [allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: 'test', reportFiles: 'index.html', reportName: 'HTML Report', reportTitles: ''])
        }
